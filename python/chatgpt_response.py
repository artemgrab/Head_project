    ...
    def get_response(self):
        ...
        if not self.censoring:
            instructions = (
                ...
                "небезпечна для життя). Відповідаєш коротко, не більше одного речення. З гумором і підколками."
            )
        else:
            instructions = (
                ...
                "В кожному слові великою літерою познач ту голосну літеру яка має бути під наголосом, а всі інші - маленькі."
            )
